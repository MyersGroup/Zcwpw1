...
proportions <- set_matrix_comb[,.("Not Zcw Alone" = sum(Zcw_Alone==0) / .N,
                             ...
                             "Zcw Alone, Not hP9, + Not ut_H3K4 + NotAlu + not H1C_H4K20" = sum(Zcw_Alone==1 & hP9_Cterm==0 & H3K4me3_UT==0 & Alu==0 & H1C_H4K20==0) / .N,
                             "Zcw Alone, Not hP9, + Not ut_H3K4 + NotAlu + H1C_H4K20" = sum(Zcw_Alone==1 & hP9_Cterm==0 & H3K4me3_UT==0 & Alu==0 & H1C_H4K20==1) / .N,
...
ctcf <- loadBed("~/Dropbox/Downloads/ENCFF314ZAL.bed")
Trim28 <- loadBed("~/Dropbox/Downloads/ENCFF860DHS.bed")
h3k9 <- loadBed("~/Dropbox/Downloads/ENCFF342JBJ.bed")
h3K27ac <- loadBed("~/Dropbox/Downloads/ENCFF451UZW.bed")
h3k4me1 <- loadBed("~/Dropbox/Downloads/ENCFF483QXH.bed")

system("cut -f 1-3 ~/Dropbox/Downloads/ENCFF001VRG.bed > ~/Dropbox/Downloads/ENCFF001VRG.bed3")
setdb1 <- loadBed("~/Dropbox/Downloads/ENCFF001VRG_hg38.bed3")
...
ctcfl <- loadBed("~/Dropbox/Downloads/ENCFF678TFE.bed") #CTCFL ChIP-seq protocol v041610.1 on human K562 https://www.encodeproject.org/experiments/ENCSR000BNK/


fraction_overlapN2(zcw_peaks_cin[cov_input>5], ctcf, "ZcwST", "ctcf", shift=1e8, n=100)

fraction_overlapN2(zcw_peaks_cin[cov_input>5], Trim28, "ZcwST", "Trim28", shift=1e8, n=100)

fraction_overlapN2(zcw_peaks_cin[cov_input>5], h3k9, "ZcwST", "h3k9", shift=1e8, n=100)

fraction_overlapN2(zcw_peaks_cin[cov_input>5], CGI, "ZcwST", "CpG Islands", shift=1e8, n=100)

fraction_overlapN2(zcw_peaks_cin[cov_input>5], h3K27ac, "ZcwST", "h3K27ac", shift=1e8, n=100)

fraction_overlapN2(zcw_peaks_cin[cov_input>5], h3k4me1, "ZcwST", "h3K4me1", shift=1e8, n=100)

fraction_overlapN2(zcw_peaks_cin[cov_input>5], setdb1, "ZcwST", "setdb1", shift=1e8, n=100)

fraction_overlapN2(zcw_peaks_cin[cov_input>5], ctcfl, "ZcwST", "Ctcfl in K562", shift=1e8, n=100)
...
H1C_H4K20 <- loadBed("~/Dropbox/Downloads/ENCFF665UWA.bed") #     Homo sapiens H1 https://www.encodeproject.org/experiments/ENCSR728SZE/
...
fraction_overlapN2(zcw_peaks_cin[cov_input>5], H1C_H4K20, "ZcwST", "H1C_H4K20", shift=1e8, n=100) # 12 to 50%
