...
forcecalled[order(-h3k36me3_hP9_enrichment)]

forcecalled$h3k4me3_hP9_enrichment

forcecalled$h3k4me3_UT

forcecalled$cP9combo_enrichment

forcecalled$hP9combo_enrichment

forcecalled$zcw_cP9_enrichment

forcecalled$zcw_hP9_enrichment

forcecalled$zcw_enrichment
```
...
tmp <- rbind(
  fraction_overlapN(forcecalled[h3k4me3_hP9_cov_input>15 & zcw_cov_input>5][UTP9==1], 
                    "h3k4me3_hP9_enrichment","zcw_hP9_enrichment", n=25, returndf = T, filter="UTP9==1", pseudoenrich = 0),
  fraction_overlapN(forcecalled[h3k4me3_hP9_cov_input>15 & zcw_cov_input>5][UTP9==2], 
                    "h3k4me3_hP9_enrichment","zcw_hP9_enrichment", n=25, returndf = T, filter="UTP9==2", pseudoenrich = 0)
)
...
log(+0.01)
gam_y <- gam(zcw_hP9_enrichment ~ s((h3k4me3_hP9_enrichment), by=UTP9F) + UTP9F, method = "REML", data = forcecalled[h3k4me3_hP9_cov_input>15 & zcw_cov_input>5][!is.na(UTP9F)]) #[UTP9==1]
...
n=500
x_new <- seq(0.15, 30, length.out = n) #0.15
