...
Alu100bp_f0.5 <- fread("repeats/Repeat_MaskerSorted_Alu_QC_100bp_f0.5.bed") # 0.5 actually 1.0, meaning Alu must overlap full 100bp
...
```{r}
cpgImeth <- fread("CpG/cpgIsland_Meth.bed")
...
CpG_100bp <- fread("CpG/CpG_hg38_100bpwindows.bed")

M7 <- fread("motifs/motif_locs_M7_100bpwindows.bed")
...
CpG_Island_100bp <- fread("CpG/cpgIslandExtUnmasked_100bpwindows.bed")
setnames(CpG_Island_100bp, c("chr","center_start","center_stop","CpG_Island"))
forcecalled <- merge(forcecalled, CpG_Island_100bp)

CpG_Island_100bp <- fread("CpG/cpgIslandExtUnmasked_100bpwindows_f1.bed")
...
cpg_Meth_100bp <- fread("CpG/cpg_Meth_100bpwindows.bed")
...
fimo <- fread("motifs/fimo_M4_WG_100bpwindows.bed")
...
seqkit <- fread("motifs/motif_locs_CHB6_100bpwindows.bed")
...
saveRDS(p,"CpG/NormalPeaks300bp.rds")
