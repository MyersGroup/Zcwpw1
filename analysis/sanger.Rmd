...
wt <- readsangerseq("../data/ZCWPW1 project/Paper/Figures/WT allele_ZCW_read as is.ab1")
ko <- readsangerseq("../data/ZCWPW1 project/Paper/Figures/KO allele_ZCW_ read as reverse complement.ab1")
