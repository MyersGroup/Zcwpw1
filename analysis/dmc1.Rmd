...
p <- ggplot(rbind(A,X), aes(SPO11, DMC1, colour=Chr)) +
  ...
  coord_cartesian(xlim = c(0,12), ylim=c(0,15))+
  scale_x_continuous(breaks = c(0,4,8,12))+
  geom_pointrange(data=Amean[DMC1<15 & SPO11<12], aes(ymin=SPO11_min, ymax=SPO11_max), size=0.35, colour="darkred") +
  geom_pointrange(data=Xmean[DMC1<15 & SPO11<12], aes(ymin=SPO11_min, ymax=SPO11_max), size=0.35, colour="blue") +
...
dmc1_ssds <- readRDS("../results/dmc1/DMC1_SSDS_plot.rds")
dmc1_curveline <- readRDS("../results/dmc1/dmc1_curveline.rds")
dmc1_stratified <- readRDS("../results/dmc1/DMC1_stratified.rds")
