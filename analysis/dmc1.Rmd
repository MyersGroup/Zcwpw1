...
dmc1_curveline <- readRDS("../results/dmc1_curveline.rds")
dmc1_stratified <- readRDS("../results/DMC_stratified.rds")


pdf("../results/DMC1_B.pdf", width = 7, height = 7*1.5)
cowplot::plot_grid(dmc1_ssds,
                   dmc1_curveline,
                   dmc1_stratified + theme(legend.position = "right"),
                   nrow=3,
                   labels="AUTO", rel_heights = c(5,4,4))
dev.off()


dmc1_stratified2 <- dmc1_stratified +
...
pdf("../results/DMC1_C.pdf", width = 7, height = 7*1.5)
cowplot::plot_grid(dmc1_ssds,
                   dmc1_stratified2,
                   dmc1_curveline,
                   nrow=3,
