...
rad51_counts_ZCW <- readxl::read_excel("../data/Rad51.xlsx", sheet = "ZCW KO")
...
rad51_counts_P9KO <- readxl::read_excel("../data/Rad51.xlsx", sheet = "Prdm9 KO")
...
rad51_counts_WT <- readxl::read_excel("../data/Rad51.xlsx", sheet = "Wt unrelated")
...
fwrite(rbind(dmc1_counts, rad51_counts), "../results/DMC1_RAD51_Counts.tsv")
