...
rad51_counts$Stage <- factor(rad51_counts$Stage, levels = c("L","Late L","Early Z","Z","Late Z","(Pseudo)P","Late P"))
rad51_counts$Genotype <- factor(rad51_counts$Genotype, levels = c("WT","Zcwpw1 KO","Prdm9 KO"))

for(stage in c("Late L","Early Z","Z","Late Z","(Pseudo)P")){
...
rpa_counts$Stage <- factor(rpa_counts$Stage, levels = c("L","Late L","Early Z","Z","Late Z","(Pseudo)P","Late P"))
rpa_counts$Genotype <- factor(rpa_counts$Genotype, levels = c("WT","Zcwpw1 KO","Prdm9 KO"))
rpa_counts[, Foci := as.numeric(Foci)]


for(stage in c("Early Z","Z","Late Z","(Pseudo)P")){
