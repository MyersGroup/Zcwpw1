...
weights <- data.table(lean_body_weight=c(19.7,21.98,19.8,20.42,22.56,20.66, 18.89, 19.62, 21.77, 22.36),
           ...
           Genotype=c("Zcwpw1-/-","Zcwpw1-/-","Zcwpw1+/+","Zcwpw1+/+","Zcwpw1+/+","Zcwpw1-/-","Zcwpw1-/-","Zcwpw1-/-", "Prdm9-/-", "Prdm9-/-"))
...
cowplot::plot_grid(pw, ps, nrow=1, labels=c("A","C"))
ggsave("../results/weight_&_synapsis.pdf", width = 8, height = 4)
```
