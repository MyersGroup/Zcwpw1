...
dmc1_counts$Genotype <- factor(dmc1_counts$Genotype, levels = c("Wild Type","Wild Type (unrelated)","ZCW -/-","Prdm9 -/-"))

ggplot(dmc1_counts, aes(Stage, `DMC1 foci`, colour=Genotype)) + 
