...
dmc1_counts_P9 <- readxl::read_excel("../data/zcw_dmc1.xlsx", sheet = "Prdm9 KO", skip=1)
...
dmc1_counts_P9B <- readxl::read_excel("../data/Second prdm9 KO DMC1 foci.xlsx", skip = 1)
...
ggplot(data.table(dmc1_counts)[Genotype=="Prdm9 -/-"], aes(Stage, `DMC1 foci`, colour=Mouse, group=Mouse)) + 
...
rad51_counts_ZCW <- readxl::read_excel("../data/Rad51.xlsx", sheet = "ZCW KO", skip = 1)

colnames(rad51_counts_ZCW) <- c("Image","Stage","Foci","NA1","NA2","Image","Stage","Foci")

rad51_counts_ZCW <- rbind(rad51_counts_ZCW[,1:3],
                     rad51_counts_ZCW[,6:8])
...
rad51_counts_P9KO <- readxl::read_excel("../data/Rad51.xlsx", sheet = "Prdm9 KO", skip = 1)

colnames(rad51_counts_P9KO) <- c("Image","Stage","Foci")
...
rad51_counts_WT <- readxl::read_excel("../data/Rad51.xlsx", sheet = "Wt unrelated", skip = 1)

colnames(rad51_counts_WT) <- c("Image","Stage","Foci","NA1","NA2","Image","Stage","Foci")

rad51_counts_WT <- rbind(rad51_counts_WT[,1:3],
                     rad51_counts_WT[,6:8])
