...
--skipZeros \
--sortRegions keep \
-o deeptools/matrices/HP9N_overlap_ZcwCVC_sorted.gz

## plot

plotHeatmap -m deeptools/matrices/HP9N_overlap_ZcwCVC_sorted.gz \
-out deeptools/plots/Methylation_AT_HP9N_overlapZcw.png \
--colorMap RdBu \
--samplesLabel ZcwCVC hP9N hP9C H3K4me3, H3K36me3 \
--zMax 0.65 0.65 0.65 0.65 0.15 \
--yMax 0.45 0.45 0.65 0.45 0.1 \
--sortRegions keep \
-z regions \
--dpi 600 \
--outFileNameMatrix deeptools/plots/Methylation_AT_HP9N_overlapZcw.tab
...
--skipZeros \
--sortRegions keep \
-o deeptools/matrices/HP9N_NOToverlap_ZcwCVC_sorted.gz

## plot

plotHeatmap -m deeptools/matrices/HP9N_NOToverlap_ZcwCVC_sorted.gz \
-out deeptools/plots/Methylation_AT_HP9N_NOToverlapZcw.png \
--colorMap RdBu \
--samplesLabel ZcwCVC hP9N hP9C H3K4me3, H3K36me3 \
--zMax 0.65 0.65 0.65 0.65 0.15 \
...
deeptools/bigwigs/SRA_Altemose2015_SRR5627152_vs_SRA_Altemose2015_SRR5627143_CPM_log2.bw \
deeptools/bigwigs/SRA_Altemose2015_SRR5627149_vs_SRA_Altemose2015_SRR5627143_CPM_log2.bw \
-R bed6/SingleBasePeaks.SRA_Altemose2015_SRR5627146_AND_SRA_Altemose2015_SRR5627147_vs_SRA_Altemose2015_SRR5627143.p0.000001.sep250.ALL_MotifCenteredStranded.bed00 \
-a 2000 \
-b 2000 \
-p 15 \
--skipZeros \
--sortRegions keep \
-o deeptools/matrices/HP9C.gz

## plot

plotHeatmap -m deeptools/matrices/HP9C.gz \
-out deeptools/plots/Methylation_AT_HP9C.png \
--colorMap RdBu \
--samplesLabel ZcwCVC hP9N hP9C H3K4me3, H3K36me3 \
--zMax 0.65 0.65 0.65 0.65 0.15 \
--yMax 0.45 0.45 0.65 0.45 0.1 \
